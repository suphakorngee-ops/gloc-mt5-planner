// Exports recent candles to CSV for the Python planner.
// Attach this EA to the XAUUSDm chart and keep MT5 open.
#property strict

input string ExportSymbol = "XAUUSDm";
input ENUM_TIMEFRAMES ExportTimeframe = PERIOD_M5;
input int BarsToExport = 10000;
input int TimerSeconds = 5;
input string FileName = "xauusdm_m5.csv";
