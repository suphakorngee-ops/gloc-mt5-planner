...
$Mt5Csv = "C:\Users\jiasny\AppData\Roaming\MetaQuotes\Terminal\D0E8209F77C8CF37AD8BF550E51FF075\MQL5\Files\btcusdm_m5.csv"
$LocalCsv = Join-Path $ProjectDir "btcusdm_m5.csv"
...
while ($true) {
    ...
    & $Python -m mt5_planner csv --config config_btc.json --once
